...
這個Repo的製作原因是因為香港與內地通關，許多香港人喜歡前往內地消費。然而，眾所周知，內地有國家防火牆，因此像Facebook、Instagram等應用程序在內地無法正常運行。對於許多香港人來說，這些應用程序是日常生活中的重要組成部分，無法使用它們就像戒除毒癮一樣令人不適。因此，這篇文章旨在教大家如何在短時間內解決這個問題，讓大家在內地暢享購物的同時也能繼續使用這些應用程序，例如在Instagram上分享動態。建議大家在前往內地之前先配置好這些解決方案。
